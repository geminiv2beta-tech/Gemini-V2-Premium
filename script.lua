-- [ vallkmult free v1 - Ultimate Rivals Rage & Legit Integration (Heavy Obfuscated 0x_ Layer) ]
local _0x_ENV = (getgenv and getgenv()) or _G
local _0x_Pcall = pcall
local _0x_TblConcat = table.concat
local _0x_StringChar = string.char

local _0x_StrMap = {
    [0x01] = {107, 105, 99, 105, 97, 104, 111, 111, 107, 47, 114, 105, 118, 97, 108, 115, 47}, -- kiciahook/rivals/
    [0x02] = {99, 111, 115, 109, 101, 116, 105, 99, 115}, -- cosmetics
    [0x03] = {99, 111, 110, 102, 105, 103, 115}, -- configs
    [0x04] = {80, 108, 97, 121, 101, 114, 115}, -- Players
    [0x05] = {82, 117, 110, 83, 101, 114, 118, 105, 99, 101}, -- RunService
    [0x06] = {85, 115, 101, 114, 73, 110, 112, 117, 116, 83, 101, 114, 118, 105, 99, 101}, -- UserInputService
    [0x07] = {67, 111, 114, 101, 71, 117, 105}, -- CoreGui
    [0x08] = {72, 116, 116, 112, 83, 101, 114, 118, 105, 99, 101}, -- HttpService
    [0x09] = {82, 101, 112, 108, 105, 99, 97, 116, 101, 100, 83, 116, 111, 114, 97, 103, 101}, -- ReplicatedStorage
    [0x0A] = {87, 111, 114, 107, 115, 112, 97, 99, 101}, -- Workspace
    [0x0B] = {76, 105, 103, 104, 116, 105, 110, 103}, -- Lighting
}

local function _0x_GetStr(_0x_id)
    local _0x_res = {}
    local _0x_arr = _0x_StrMap[_0x_id]
    if not _0x_arr then return "" end
    for _0x_i = 1, #_0x_arr do
        _0x_res[_0x_i] = _0x_StringChar(_0x_arr[_0x_i])
    end
    return _0x_TblConcat(_0x_res)
end

local _0x_HOME_DIR = _0x_GetStr(0x01)
if makefolder then
    _0x_Pcall(makefolder, _0x_HOME_DIR)
    _0x_Pcall(makefolder, _0x_HOME_DIR .. _0x_GetStr(0x02))
    _0x_Pcall(makefolder, _0x_HOME_DIR .. _0x_GetStr(0x03))
end
...
do
    ...
    local _0x_Players = _0x_SafeRef(game:GetService(_0x_GetStr(0x04)))
    local _0x_RunService = _0x_SafeRef(game:GetService(_0x_GetStr(0x05)))
    local _0x_UserInputService = _0x_SafeRef(game:GetService(_0x_GetStr(0x06)))
    local _0x_CoreGui = _0x_SafeRef(game:GetService(_0x_GetStr(0x07)))
    local _0x_HttpService = _0x_SafeRef(game:GetService(_0x_GetStr(0x08)))
    local _0x_ReplicatedStorage = _0x_SafeRef(game:GetService(_0x_GetStr(0x09)))
    local _0x_Workspace = _0x_SafeRef(game:GetService(_0x_GetStr(0x0A)))
    local _0x_Lighting = _0x_SafeRef(game:GetService(_0x_GetStr(0x0B)))
    ...
    _0x_Pcall(function()
        ...
        if hookmetamethod and getnamecallmethod then
            ...
            _0x_oldNamecall = hookmetamethod(game, "__namecall", newcclosure(function(self, ...)
                local _0x_method = getnamecallmethod()
                if _0x_method == "Kick" or _0x_method == "kick" then
                    return
                end

                if (_0x_method == "FireServer" or _0x_method == "InvokeServer") and self then
                    local _0x_sName = ""
                    _0x_Pcall(function() _0x_sName = string.lower(tostring(self.Name or "")) end)
    ...
    function _0x_UISection.new(_0x_parentContainer, _0x_side, _0x_label)
        ...
        _0x_container.Parent = _0x_parentContainer[_0x_side]
        return _0x_self
    end
    ...
    function _0x_UIBase.new()
        ...
        _0x_self.instances.uiScale = _0x_uiScale
        ...
        _0x_openBtn.AnchorPoint = Vector2.new(0, 0.5)
        _0x_openBtn.Position = UDim2.new(0, 12, 0.5, 0)
        _0x_openBtn.Size = UDim2.new(0, 78, 0, 32)
    ...
    function _0x_UIToggle.new(_0x_section, _0x_flag, _0x_labelText, _0x_defaultVal, _0x_callback)
    ...
    function _0x_UISlider.new(_0x_section, _0x_flag, _0x_labelText, _0x_min, _0x_max, _0x_defaultVal, _0x_callback)
        ...
        _0x_section.instances.container.Size += UDim2.new(0, 0, 0, 28)

        local _0x_container = Instance.new("Frame")
        _0x_container.BackgroundTransparency = 1
        _0x_container.Size = UDim2.new(1, 0, 0, 26)
        _0x_container.Parent = _0x_section.instances.canvas
    ...
    function _0x_UIDropdown.new(_0x_section, _0x_flag, _0x_labelText, _0x_list, _0x_defaultVal, _0x_callback)
        local _0x_self = setmetatable({}, _0x_UIDropdown)
        _0x_self.value = _0x_defaultVal or _0x_list[1]
        _0x_self.callback = _0x_callback or function() end
        _0x_self.open = false

        _0x_section.instances.container.Size += UDim2.new(0, 0, 0, 38)
    ...
    -- [ DEVICE SPOOFER ]
    --------------------------------------------------------------------
    _0x_ENV.DeviceSpooferEnabled = _0x_ENV.MultConfig.DeviceSpooferEnabled
    _0x_ENV.SpoofedDeviceMode = _0x_ENV.MultConfig.SpoofedDeviceMode or "MouseKeyboard"
    ...
    local function _0x_getSetControlsRemote()
        local _0x_ok, _0x_remote = _0x_Pcall(function()
    ...
    local function _0x_fireDeviceSetControls(_0x_mode)
        _0x_mode = _0x_normalizeDeviceMode(_0x_mode or _0x_ENV.SpoofedDeviceMode)
        _0x_ENV.SpoofedDeviceMode = _0x_mode
        if _0x_ENV.MultConfig then
            _0x_ENV.MultConfig.SpoofedDeviceMode = _0x_mode
        end
        local _0x_remote = _0x_getSetControlsRemote()
        if not _0x_remote then return false end
        _0x_Pcall(function()
            _0x_remote:FireServer(_0x_mode)
        end)
        return true
    end
    ...
    task.spawn(function()
        while true do
            task.wait(2.5)
            if _0x_ENV.DeviceSpooferEnabled or (_0x_ENV.MultConfig and _0x_ENV.MultConfig.DeviceSpooferEnabled) then
                _0x_fireDeviceSetControls(_0x_ENV.SpoofedDeviceMode)
            end
        end
    end)
    ...
    _0x_UIToggle.new(_0x_mainSec, "WelcomeToggle", "vallkmult free v1 허브 활성화됨", true, function(v) end)

    local _0x_rageSec = _0x_UISection.new(_0x_rageTab, "left", "Ragebot Settings")
    _0x_UIDropdown.new(_0x_rageSec, "RageVersion", "레이지봇 버전 선택", {"vallkmult_premium_v6", "vallkmult_old_rage_bot_v3"}, "vallkmult_premium_v6", function(sel)
        _0x_ENV.MultConfig.RageVersion = sel
    end)
    _0x_UIToggle.new(_0x_rageSec, "RagebotToggle", "레이지봇 활성화 (RageBot)", true, function(val)
        _0x_ENV.MultConfig.RageEnabled = val
    end)
    _0x_UISlider.new(_0x_rageSec, "FireRateSlider", "발사 속도 (FireRate)", 0.0001, 0.01, 0.0005, function(val)
        _0x_ENV.MultConfig.FireRate = val
    end)

    local _0x_aimSec = _0x_UISection.new(_0x_combatTab, "left", "Aimbot Settings")
    _0x_UIToggle.new(_0x_aimSec, "AimbotToggle", "에임봇 활성화", false, function(v) _0x_ENV.MultConfig.AimbotEnabled = v end)
    _0x_UIDropdown.new(_0x_aimSec, "AimPart", "에임봇 타겟 파트", {"Head", "HumanoidRootPart", "Torso"}, "Head", function(v) _0x_ENV.MultConfig.AimbotHitPart = v end)
    _0x_UIToggle.new(_0x_aimSec, "AimFOV", "에임봇 FOV 표시 (Draw FOV)", false, function(v) _0x_ENV.MultConfig.AimbotDrawFOV = v end)
    _0x_UIToggle.new(_0x_aimSec, "AimWall", "에임봇 벽 체크 (Wallcheck)", false, function(v) _0x_ENV.MultConfig.AimbotWallCheck = v end)

    local _0x_silentSec = _0x_UISection.new(_0x_combatTab, "right", "Silent Aim Settings")
    _0x_UIToggle.new(_0x_silentSec, "SilentToggle", "사일런트 에임 활성화", false, function(v) _0x_ENV.MultConfig.SilentEnabled = v end)
    _0x_UIDropdown.new(_0x_silentSec, "SilentPart", "사일런트 타겟 파트", {"Head", "HumanoidRootPart", "Torso"}, "Head", function(v) _0x_ENV.MultConfig.SilentHitPart = v end)
    _0x_UIToggle.new(_0x_silentSec, "SilentFOV", "사일런트 FOV 표시 (Draw FOV)", false, function(v) _0x_ENV.MultConfig.SilentDrawFOV = v end)
    _0x_UIToggle.new(_0x_silentSec, "SilentWall", "사일런트 벽 체크 (Wallcheck)", false, function(v) _0x_ENV.MultConfig.SilentWallCheck = v end)
    _0x_UIToggle.new(_0x_silentSec, "SilentScope", "사일런트 Scope Look", false, function(v) _0x_ENV.MultConfig.SilentScopeLook = v end)

    local _0x_trigSec = _0x_UISection.new(_0x_combatTab, "right", "Triggerbot")
    _0x_UIToggle.new(_0x_trigSec, "TriggerToggle", "트리거봇 활성화 (Triggerbot)", false, function(v) _0x_ENV.MultConfig.TriggerbotEnabled = v end)

    local _0x_espSec = _0x_UISection.new(_0x_espTab, "left", "ESP Visuals")
    _0x_UIToggle.new(_0x_espSec, "EspToggle", "플레이어 시각화 (ESP)", false, function(v) _0x_ENV.MultConfig.EspEnabled = v end)
    _0x_UIToggle.new(_0x_espSec, "BoxEsp", "박스 ESP (Box)", false, function(v) _0x_ENV.MultConfig.BoxEsp = v end)
    _0x_UIToggle.new(_0x_espSec, "NameEsp", "이름 ESP (Name)", false, function(v) _0x_ENV.MultConfig.NameEsp = v end)
    _0x_UIToggle.new(_0x_espSec, "HealthEsp", "체력바 ESP (Health)", false, function(v) _0x_ENV.MultConfig.HealthEsp = v end)

    local _0x_miscSec = _0x_UISection.new(_0x_miscTab, "left", "Miscellaneous")
    _0x_UIToggle.new(_0x_miscSec, "BypassStatus", "안티 치트 바이패스 활성됨", true, function(v) end)

    local _0x_spooferSec = _0x_UISection.new(_0x_spooferTab, "left", "Device Spoofer")
    _0x_UIToggle.new(_0x_spooferSec, "DeviceSpooferMaster", "Enable Device Spoofer", false, function(v)
        _0x_ENV.DeviceSpooferEnabled = v
        _0x_ENV.MultConfig.DeviceSpooferEnabled = v
        if v then _0x_fireDeviceSetControls(_0x_ENV.SpoofedDeviceMode) end
    end)
    _0x_UIToggle.new(_0x_spooferSec, "DeviceVR", "Device: VR", false, function(v)
        if v then
            _0x_ENV.SpoofedDeviceMode = _0x_normalizeDeviceMode("vr")
            _0x_ENV.MultConfig.SpoofedDeviceMode = _0x_ENV.SpoofedDeviceMode
            if _0x_ENV.DeviceSpooferEnabled then _0x_fireDeviceSetControls() end
        end
    end)
    _0x_UIToggle.new(_0x_spooferSec, "DeviceTouch", "Device: Touch", false, function(v)
        if v then
            _0x_ENV.SpoofedDeviceMode = _0x_normalizeDeviceMode("touch")
            _0x_ENV.MultConfig.SpoofedDeviceMode = _0x_ENV.SpoofedDeviceMode
            if _0x_ENV.DeviceSpooferEnabled then _0x_fireDeviceSetControls() end
        end
    end)
    _0x_UIToggle.new(_0x_spooferSec, "DeviceGamepad", "Device: Gamepad", false, function(v)
        if v then
            _0x_ENV.SpoofedDeviceMode = _0x_normalizeDeviceMode("gamepad")
            _0x_ENV.MultConfig.SpoofedDeviceMode = _0x_ENV.SpoofedDeviceMode
            if _0x_ENV.DeviceSpooferEnabled then _0x_fireDeviceSetControls() end
        end
    end)
    _0x_UIToggle.new(_0x_spooferSec, "DeviceMouseKeyboard", "Device: MouseKeyboard", true, function(v)
        if v then
            _0x_ENV.SpoofedDeviceMode = _0x_normalizeDeviceMode("mousekeyboard")
            _0x_ENV.MultConfig.SpoofedDeviceMode = _0x_ENV.SpoofedDeviceMode
            if _0x_ENV.DeviceSpooferEnabled then _0x_fireDeviceSetControls() end
        end
    end)
    ...
    local function _0x_removeESP(_0x_plr)
        if _0x_ESP_Cache[_0x_plr] then
            for _, _0x_obj in pairs(_0x_ESP_Cache[_0x_plr]) do
                _0x_Pcall(function() _0x_obj:Remove() end)
            end
    ...
    --------------------------------------------------------------------
    local _0x_Utility = _0x_Pcall(function() return require(_0x_ReplicatedStorage.Modules.Utility) end) and require(_0x_ReplicatedStorage.Modules.Utility) or nil
    local _0x_EnumLibrary = _0x_Pcall(function() return require(_0x_ReplicatedStorage.Modules.EnumLibrary) end) and require(_0x_ReplicatedStorage.Modules.EnumLibrary) or nil
    local _0x_FighterController = _0x_Pcall(function() return require(_0x_LocalPlayer.PlayerScripts.Controllers.FighterController) end) and require(_0x_LocalPlayer.PlayerScripts.Controllers.FighterController) or nil
    local _0x_SpectateController = _0x_Pcall(function() return require(_0x_LocalPlayer.PlayerScripts.Controllers:WaitForChild("SpectateController")) end) and require(_0x_LocalPlayer.PlayerScripts.Controllers:WaitForChild("SpectateController")) or nil
    ...
    local function _0x_wallCheckPass(_0x_targetPart)
        ...
        if _0x_result and _0x_result.Instance then
            ...
            if _0x_model and _0x_model == _0x_targetPart.Parent then
                return true
            end
            return false
        end
    ...
    local function _0x_getClosestTargetToCursor(_0x_maxDist, _0x_needWallCheck, _0x_partName)
        ...
        local _0x_closestPlr = nil
        local _0x_closestPart = nil
        local _0x_shortestDist = _0x_maxDist
    ...
    _0x_RunService.Heartbeat:Connect(function()
        _0x_fovAimCircle.Visible = _0x_ENV.MultConfig.AimbotDrawFOV and _0x_ENV.MultConfig.AimbotEnabled
        _0x_fovAimCircle.Position = _0x_UserInputService:GetMouseLocation()
        _0x_fovAimCircle.Radius = _0x_ENV.MultConfig.AimbotFOVSize

        _0x_fovSilentCircle.Visible = _0x_ENV.MultConfig.SilentDrawFOV and _0x_ENV.MultConfig.SilentEnabled
        _0x_fovSilentCircle.Position = _0x_UserInputService:GetMouseLocation()
        _0x_fovSilentCircle.Radius = _0x_ENV.MultConfig.SilentFOVSize

        for _0x_plr, _0x_drawings in pairs(_0x_ESP_Cache) do
            local _0x_show = _0x_ENV.MultConfig.EspEnabled and _0x_plr.Character and _0x_plr.Character:FindFirstChild("HumanoidRootPart") and _0x_plr.Character:FindFirstChildWhichIsA("Humanoid") and _0x_plr.Character.Humanoid.Health > 0
            if _0x_show then
                local _0x_char = _0x_plr.Character
                ...
                if _0x_onScreen then
                    ...
                    if _0x_ENV.MultConfig.BoxEsp then
                    ...
                    if _0x_ENV.MultConfig.NameEsp then
                    ...
                    if _0x_ENV.MultConfig.HealthEsp then
        ...
        if _0x_ENV.MultConfig.AimbotEnabled and _0x_UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton2) then
            local _, _0x_targetPart = _0x_getClosestTargetToCursor(_0x_ENV.MultConfig.AimbotFOVSize, _0x_ENV.MultConfig.AimbotWallCheck, _0x_ENV.MultConfig.AimbotHitPart)
            if _0x_targetPart then
                _0x_Camera.CFrame = CFrame.lookAt(_0x_Camera.CFrame.Position, _0x_targetPart.Position)
            end
        end

        if _0x_ENV.MultConfig.TriggerbotEnabled then
        ...
        if not _0x_ENV.MultConfig.RageEnabled then return end
        ...
        if _0x_targetPlr and _0x_targetHead and _0x_targetHRP then
            ...
            if _0x_FighterController and _0x_FighterController.LocalFighter and _0x_Utility and _0x_EnumLibrary then
                ...
                if _0x_item and tick() - _0x_lastFireTick >= _0x_ENV.MultConfig.FireRate then
