-- ==================================================
-- Gemini V2 Premium (Beta) - Auto Fire, ESP & Rotating FOV Circle
-- ==================================================
...
local isFlying, isNoclipping, isAimbot, isFOVCircle, isAutoFire = false, false, false, false, false
...
-- ==========================================
-- 2. GUI 생성 (CanvasSize 900px)
-- ==========================================
local screenGui = Instance.new("ScreenGui")
screenGui.Name = "GeminiV2PremiumGui"
...
toggleMenuBtn.Size = UDim2.new(0, 180, 0, 45)
toggleMenuBtn.Position = UDim2.new(0, 20, 0, 20)
toggleMenuBtn.Text = "Gemini V2 Premium (Beta)"
...
mainFrame.CanvasSize = UDim2.new(0, 0, 0, 750)
...
local autoFireBtn = createButton("Auto Fire : OFF", 11)
...
local fireDelayInput = createInputGroup("Fire Delay (0.05 ~ 10s)", "0.5", 12)
local speedInput = createInputGroup("Fly Speed (1 ~ 10000)", "50", 13)
local fovInput = createInputGroup("FOV Radius (50 ~ 360)", "160", 14)

-- ==========================================
-- 3. 원 회전 애니메이션 로직
-- ==========================================
local circleRotationSpeed = 180 -- 초당 회전 속도
...
toggleMenuBtn.MouseButton1Click:Connect(function()
	...
	toggleMenuBtn.Text = menuOpen and "Gemini V2 Premium (Close)" or "Gemini V2 Premium (Beta)"
end)
